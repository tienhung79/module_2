...
public class Employee extends Person {
    ...
    public Employee(int id, String name, String dateOfBirth, String gender, int idCMND, String numberOfPhone, String email, String level, String options, int salary) {
